...
#genre_data = read.csv("popularity_songs.csv")
...
```{r, echo=F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/FeaturesBoxplot_Norm.png?token=AAACJKDVCHLEEDRARGNFY4DASJQYK")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Acousticness.png?token=AAACJKGKG4ZJQR5Y3OKI4ADASJQ4E")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Danceability.png?token=AAACJKAAZECGMNAKSEBPBMTASJRB2")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Energy.png?token=AAACJKCNPDBYVWZ52FFQDXTASJRE4")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Instrumentalness.png?token=AAACJKDWKRFOPRSSBMO2SKTASJRF4")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Loudness.png?token=AAACJKFESIGVUPFGSYBNTILASJRIA")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Popularity.png?token=AAACJKFA45WNXFVJELMET6DASJRKK")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Speechiness.png?token=AAACJKCCJ6ES7LCJSFFDNRLASJRMG")
```
...
```{r, echo=F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/NumClusters_Chosen.png?token=AAACJKDVSWYLUMVVVXSVC5LASIWGG")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/PCClusterPlot_6.png?token=AAACJKGS26UEFRRIFYQPDWLASJCFM")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/PCClusterPlot_2.png?token=AAACJKC2ZIZIRWGI7MVURHDASJCA6")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/RadarCluster_2_1.png?token=AAACJKCAPSYK636GZCJGTFDASJOPS")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/RadarCluster_2_2.png?token=AAACJKCJEO65DQOBVPOTK5TASJOQA")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/FeaturesPlot_byClusters_2.png?token=AAACJKAUBC44DABKMCL3SY3ASJPFI")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/FeaturesPlot_byCountry.png?token=AAACJKH42DUH5KFZDK7BZBDASJORW")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Tukey_Acousticness.png?token=AAACJKBO77UQ3PFTQ6DG6EDASLGL4")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Tukey_Danceability.png?token=AAACJKEAC5QGZXCAOZPPIG3ASLGTI")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Tukey_Loudness.png?token=AAACJKAXSR4L3RY6LBYOQMLASLGV6")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Tukey_Tempo.png?token=AAACJKEUX7VGGUS73MESUW3ASLGYK")
```
...
```{r, echo = F}
knitr::include_graphics("https://raw.github.tamu.edu/finvedy/SpotifyDataAnalysis/master/figures/Tukey_Valence.png?token=AAACJKE4PIEFZSAKUNIQ7JLASLG2I")
```
...
#   valueBox(format(mean(mtcars2$mpg),digits=3), icon = "fa-users")
# })
```
